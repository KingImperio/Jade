...
def _update_via_zip(args):
    ...
    branch = "main"
    zip_url = (
        f"https://github.com/KingImperio/Jade/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/KingImperio/Jade.git",
    "git@github.com:KingImperio/Jade.git",
    "https://github.com/KingImperio/Jade",
    "git@github.com:KingImperio/Jade",
}
OFFICIAL_REPO_URL = "https://github.com/KingImperio/Jade.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from KingImperio/Jade.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/KingImperio/Jade.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/KingImperio/Jade.git' to add later."
            )
