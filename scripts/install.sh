...
# Configuration
REPO_URL_SSH="git@github.com:KingImperio/Jade.git"
REPO_URL_HTTPS="https://github.com/KingImperio/Jade.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/KingImperio/Jade/main/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
