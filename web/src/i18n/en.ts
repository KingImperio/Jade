...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateJade: "Update Jade",
    updatingJade: "Updating Jade…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Jade plugins (`hermes plugins` parity).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Jade badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Jade session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Jade sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Jade is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
