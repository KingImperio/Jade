...
description: "How to build a memory provider plugin for Jade"
---

# Building a Memory Provider Plugin

Memory provider plugins give Jade persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. This guide covers how to build one.
