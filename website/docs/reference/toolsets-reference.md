...
description: "Reference for Jade core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call Jade tools programmatically. |
